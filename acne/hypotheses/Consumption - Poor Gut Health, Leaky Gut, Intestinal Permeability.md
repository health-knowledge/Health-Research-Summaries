# Consumption - Poor Gut Health, Leaky Gut, Intestinal Permeability
...
- Do elimination diet to find food allergens or sensitivities. Start with paleo, then keto (low/no carb), then carnivore (more restrictive variant of keto) if issues still persist. Use these elimination diets as short term tools. Use cronometer to ensure you're getting vital nutrients.
 - Incorporate foods that promote gut health, such as bone broth (https://pubmed.ncbi.nlm.nih.gov/22629114/), fermented foods (like raw sauerkraut, kimchi, and raw kefir).
...
**Although, vitamin A supplementation didn't show intestinal permability improvements in a separate study, it did help with parasitic infections:**
